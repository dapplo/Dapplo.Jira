...
namespace Dapplo.Jira.Entities
{
	...
	public class Sprint : BaseProperties<long>
	{
		...
		/// </summary>
		[DataMember(Name = "startDate", EmitDefaultValue = false), ReadOnly(true)]
		public DateTimeOffset StartDate { get; set; }

		/// <summary>
		///     When was the sprint ended
		/// </summary>
		[DataMember(Name = "endDate", EmitDefaultValue = false), ReadOnly(true)]
		public DateTimeOffset EndDate { get; set; }

		/// <summary>
		///     When was the sprint completed
		/// </summary>
		[DataMember(Name = "completeDate", EmitDefaultValue = false), ReadOnly(true)]
