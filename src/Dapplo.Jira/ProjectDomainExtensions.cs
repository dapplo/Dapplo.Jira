...
namespace Dapplo.Jira
{
	...
	public static class ProjectDomainExtensions
	{
		...
		public static async Task<IEnumerable<SecurityLevel>> GetSecurityLevelsAsync(this IProjectDomain jiraClient, string projectKey, CancellationToken cancellationToken = default)
		{
